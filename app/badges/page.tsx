...
export default function BadgesPage() {
	...
	return <main className="feature-page badge-page"><div className="feature-shell badge-shell">
		...
		<section className="badge-hero"><p className="feature-kicker">WENCHANG TRUE ACHIEVEMENTS</p><span className="badge-hero-seal" aria-hidden="true">成就</span><h1>我的學習徽章</h1><p>完成專注、簽到與弱點複習，就能解鎖對應徽章。</p></section>
