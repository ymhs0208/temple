...
export default function Home() {
	...
	const completeDailyCheckIn = () => {
		...
		confetti({
			...
			spread: 80, // 散開範圍
			origin: { y: 0.5 }, // 從畫面中間噴發
			zIndex: 9999, // 確保特效會蓋在所有畫面最上層
			colors: ["#FFD700", "#FFA500", "#FF6347", "#87CEEB", "#FF69B4"], // 活潑的色彩
		});
	...
	const prayerView = (
		<section className="journey">
			...
			>
				...
				<button
					onClick={() => setDailyCheckInDialogOpen(true)}
